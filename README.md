...
The codes for these experiments can be observed in the following files: for Nonspeech7k - "Crocc-validation for Nonspeech7k" (https://github.com/Anastasiia-Pov/Research-on-experts-features-and-ML-algoritms/blob/main/Crocc-validation%20for%20Nonspeech7k.ipynb), for Vocal Sound - "Crocc-validation for Vocal Sound" ().
